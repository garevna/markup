...
Поскольку "под капотом" работает все та же прототипная модель наследования JS, создаваемые в конструкторе свойства и методы могут быть приватными и публичными ( как и в обычном конструкторе )
