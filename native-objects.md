...
* У него есть *цепочка прототипов* - вложенные друг в друга свойства  **`__proto__`**
...
lena.changeName
```
⚡ в приватных методах экземпляра контекстом вызова будет *глобальный объект* **`window`**
